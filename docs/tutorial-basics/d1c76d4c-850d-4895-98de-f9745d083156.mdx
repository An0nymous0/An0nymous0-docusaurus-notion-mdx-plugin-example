---
id: d1c76d4c-850d-4895-98de-f9745d083156
...
```
**Result:** Let's see how to [Create a page](http://localhost:3000/docs/tutorial-basics/create-a-page) .
...
```javascript title="src/components/HelloDocusaurus.js"
